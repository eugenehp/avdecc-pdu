#ifndef AVDECC_PDU_AEM_COMMAND_PRINT_HPP_
#define AVDECC_PDU_AEM_COMMAND_PRINT_HPP_
...
const char *avdecc_command_type_string( avdecc_aem_command_type_t command );
