...
#define AVDECC_BITS_QUADLET_BIT(bit) (((uint32_t)0x80000000)>>(bit))
#define AVDECC_BITS_SEXLET_BIT(bit) (((uint64_t)0x800000000000)>>(bit))
#define AVDECC_BITS_OCTLET_BIT(bit) (((uint64_t)0x8000000000000000)>>(bit))
...
#define AVDECC_BITS_SEXLET_MASK_BIT(bit) ((~AVDECC_BITS_SEXLET_BIT(bit))&0xffffffffffff)
#define AVDECC_BITS_OCTLET_MASK_BIT(bit) ((~AVDECC_BITS_OCTLET_BIT(bit))&0xffffffffffffffff)
...
#define AVDECC_BITS_SEXLET_BITFIELD(bit,width) (((0xffffffffffff)>>(48-(width)))<<(47-(bit)))
#define AVDECC_BITS_OCTLET_BITFIELD(bit,width) (((0xffffffffffffffff)>>(64-(width)))<<(63-(bit)))
...
#define AVDECC_BITS_SEXLET_MASK_BITFIELD(bit,width) ((~AVDECC_BITS_SEXLET_BITFIELD((bit),(width)))&0xffffffffffff)
#define AVDECC_BITS_OCTLET_MASK_BITFIELD(bit,width) ((~AVDECC_BITS_OCTLET_BITFIELD((bit),(width)))&0xffffffffffffffff)
