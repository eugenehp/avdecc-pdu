...
#define AVDECC_ADP_CONTROLLER_CAP_LAYER3_PROXY_BIT (30)
    ...
    /* @{ */
#define AVDECC_ADP_DEFAULT_AUDIO_SR_44K1_BIT (0)
#define AVDECC_ADP_DEFAULT_AUDIO_SR_48K_BIT (1)
#define AVDECC_ADP_DEFAULT_AUDIO_SR_88K2_BIT (2)
#define AVDECC_ADP_DEFAULT_AUDIO_SR_96K_BIT (3)
#define AVDECC_ADP_DEFAULT_AUDIO_SR_176K4_BIT (4)
#define AVDECC_ADP_DEFAULT_AUDIO_SR_192K_BIT (5)
