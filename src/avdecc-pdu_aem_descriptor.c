...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_audio_pull_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_audio_sample_rate_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_entity_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_configuration_counts_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_configuration_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_audio_unit_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_video_unit_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_sensor_unit_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_stream_format_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_stream_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_jack_flags_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_jack_type_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_jack_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_port_flags_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_audio_port_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_media_format_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_video_port_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_external_port_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_sensor_port_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_internal_port_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_msrp_mappings_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_avb_interface_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_clock_source_flags_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_clock_source_type_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_clock_source_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_audio_mapping_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_audio_map_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_audio_cluster_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_type_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_units_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_linear_format_int8_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_linear_format_uint8_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_linear_format_int16_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_linear_format_uint16_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_linear_format_int32_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_linear_format_uint32_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_linear_format_int64_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_linear_format_uint64_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_linear_format_float_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_linear_format_double_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_int8_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_uint8_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_int16_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_uint16_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_int32_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_uint32_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_int64_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_uint64_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_float_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_double_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_utf8_format_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_bode_plot_limits_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_bode_plot_entry_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_bode_plot_format_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_array_format_int8_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_array_format_uint8_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_array_format_int16_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_array_format_uint16_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_array_format_int32_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_array_format_uint32_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_array_format_int64_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_array_format_uint64_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_array_format_float_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_array_format_double_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_selector_format_string_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_control_value_type_vendor_format_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_control_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_sources_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_signal_selector_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_mixer_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_matrix_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_locale_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_strings_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_matrix_signal_entry_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_matrix_signal_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_memory_object_type_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_memory_object_operation_t ) );
}
...
{
    bzero ( ( void * ) self, sizeof ( avdecc_aem_descriptor_memory_object_t ) );
}
