...
)
{
    ...
    r&=avdecc_print_adp_message_type ( buf,offset,len, adp->message_type );
    r&=avdecc_print ( buf,offset,len,"\n%-28s", "Valid Time:" );
    r&=avdecc_print_adp_valid_time ( buf,offset,len,adp->valid_time );
    r&=avdecc_print ( buf,offset,len,"\n%-28s", "Entity GUID:" );
    r&=avdecc_print_eui64 ( buf,offset,len, &adp->entity_guid );
    r&=avdecc_print ( buf,offset,len,"\n%-28s", "Vendor Model GUID:" );
    r&=avdecc_print_eui64 ( buf,offset,len, &adp->vendor_model_id );
    r&=avdecc_print ( buf,offset,len,"\n%-28s", "Entity Capabilities:" );
    r&=avdecc_print_adp_entity_capabilities ( buf,offset,len, &adp->entity_capabilities );
    r&=avdecc_print ( buf,offset,len,"\n%-28s0x%04x", "Talker Stream Sources:", adp->talker_stream_sources );
    r&=avdecc_print ( buf,offset,len,"\n%-28s", "Talker Capabilities:" );
    r&=avdecc_print_adp_talker_capabilities ( buf,offset,len, &adp->talker_capabilities );
    r&=avdecc_print ( buf,offset,len,"\n%-28s0x%04x", "Listener Stream Sinks:", adp->listener_stream_sinks );
    r&=avdecc_print ( buf,offset,len,"\n%-28s", "Listener Capabilities:" );
    r&=avdecc_print_adp_listener_capabilities ( buf,offset,len, &adp->listener_capabilities );
    r&=avdecc_print ( buf,offset,len,"\n%-28s", "Controller Capabilities:" );
    r&=avdecc_print_adp_controller_capabilities ( buf,offset,len,&adp->controller_capabilities );
    r&=avdecc_print ( buf,offset,len,"\n%-28s0x%08x", "Available Index:", adp->available_index );
    r&=avdecc_print ( buf,offset,len,"\n%-28s", "AS Grandmaster ID:" );
    r&=avdecc_print_eui64 ( buf,offset,len, &adp->as_grandmaster_id );
    r&=avdecc_print ( buf,offset,len,"\n%-28s", "Association ID:" );
    r&=avdecc_print_eui64 ( buf,offset,len, &adp->association_id );
    r&=avdecc_print ( buf,offset,len,"\n%-28s0x%08x", "reserved1:", adp->reserved1 );
    r&=avdecc_print ( buf,offset,len,"\n%-28s0x%08x", "reserved2:", adp->reserved2 );
    r&=avdecc_print ( buf,offset,len,"\n%-28s", "Entity Type:" );
    r&=avdecc_print_adp_entity_type ( buf,offset,len, &adp->entity_type );
    r&=avdecc_print ( buf,offset,len,"\n" );
    return r;
}
